...
namespace DemoProject
{
    public class GetExchanges : GH_Component
    {
        ...
        {
            pManager.AddBoxParameter("ExchangeDetails", "Accountdetails", "Enter Account Details", GH_ParamAccess.item);
        ...
        /// </summary>
        protected override System.Drawing.Bitmap Icon => Properties.Resources.GetExchange;
